...
| 属性         | 类型                                                           | 默认值             | 必填 | 说明                                                 |
| ------------ | -------------------------------------------------------------- | ------------------ | ---- | ---------------------------------------------------- |
| value        | [SelectorModelValue](./Calendar.md#selectormodelvalue)         | []                 | 否   | 选中值                                               |
...
| -------- | ---------------------- | --------------------------------------------------------------- | ---------------- |
| onChange | 选择后值发生改变时触发 | payload: [SelectorModelValue](./Calendar.md#selectormodelvalue) | SelectorOnChange |
...
| 事件                 | 描述                                              | 回调函数参数                                                          | 函数 TypeScript           |
| -------------------- | ------------------------------------------------- | --------------------------------------------------------------------- | ------------------------- |
| onConfirm            | 选择完毕后触发 / `showConfirm` 点击确定按钮后触发 | payload: [CalendarDetail](./Calendar.md#calendardetail)               | CalendarOnConfirm         |
...
| 事件     | 描述                   | 回调函数参数                                                    | 函数 TypeScript  |
| -------- | ---------------------- | --------------------------------------------------------------- | ---------------- |
| onSelect | 选择后触发             | payload: [CalendarDetail](./Calendar.md#calendardetail)         | CalendarOnSelect |
| onChange | 选择后值发生改变时触发 | payload: [SelectorModelValue](./Calendar.md#selectormodelvalue) | SelectorOnChange |
