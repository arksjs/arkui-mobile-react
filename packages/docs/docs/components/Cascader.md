...
| value      | [SelectorModelValue](./Cascader.md#selectormodelvalue)         | []                                                       | 否   | 选中值                                               |
...
| -------- | --------------------------- | --------------------------------------------------------------- | ---------------- |
| onChange | 选择后 value 发生改变时触发 | payload: [SelectorModelValue](./Cascader.md#selectormodelvalue) | SelectorOnChange |
| onSelect | 选择后触发                  | payload: [CascaderDetail](./Cascader.md#cascaderdetail)         | CascaderOnSelect |
...
| 事件                 | 描述                 | 回调函数参数                                                          | 函数 TypeScript           |
| -------------------- | -------------------- | --------------------------------------------------------------------- | ------------------------- |
| onConfirm            | 点击确定按钮后触发   | payload: [CascaderDetail](./Cascader.md#cascaderdetail)               | CascaderOnConfirm         |
| onCancel             | 点击蒙层关闭后触发   |                                                                       | PopupOnCancel             |
| onChange             | 选中值发生变化时触发 | payload: [SelectorModelValue](./Cascader.md#selectormodelvalue)       | SelectorOnChange          |
...
| 事件     | 描述                     | 回调函数参数                                                    | 函数 TypeScript  |
| -------- | ------------------------ | --------------------------------------------------------------- | ---------------- |
| onChange | 选择完毕后发生变化时触发 | payload: [SelectorModelValue](./Cascader.md#selectormodelvalue) | SelectorOnChange |
| onSelect | 每次选择完毕时触发       | payload: [CascaderDetail](./Cascader.md#cascaderdetail)         | CascaderOnSelect |
